...
//         console.log(token)
//       // Set the headers for the API request with the token
//       const config = {
//         headers: {
    //           Authorization: `Bearer ${token}`,
    //         },
...
//       const {response} = await axios.get(`${BASE_URL}/api/v1/me`, config);
...
// if (cookies) {
    //     cookies.forEach(cookie => {
        //         const parsedCookie = cookie.split(';')[0] // Remove the "expires" and "path" attributes
        //         Cookies.set(parsedCookie.split('=')[0], parsedCookie.split('=')[1], { expires: 7 }) // Save the cookie in the browser for 7 days
//     })
// }
